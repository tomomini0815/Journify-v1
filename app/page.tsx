...
export default function LandingPage() {
  ...
  return (
    <>
      ...
      {/* Dynamic Background: Real Sunrise 竊・Daytime 竊・Sunset 竊・Space */}
      ...
      <div ref={containerRef} className="relative text-[#e1e1e1] selection:bg-white selection:text-black overflow-x-hidden">
        ...
        <nav className="fixed top-0 left-0 right-0 z-40 flex items-center justify-between px-6 md:px-8 py-6 mix-blend-difference">
          <MagneticButton>
            <div className="text-xl font-bold tracking-tighter cursor-pointer">JOURNIFYﾂｮ</div>
          </MagneticButton>
        ...
        <section className="relative h-[100vh] md:h-[120vh] flex flex-col items-center justify-center overflow-hidden">
          ...
          <div className="z-10 text-center mix-blend-difference pointer-events-none px-4">
            ...
            >
              <p>譌･縲・・蜉ｪ蜉帙′縲∫｢ｺ縺九↑譛ｪ譚･繧堤ｯ峨￥縲・/p>
              <p>縺ゅ↑縺溘・驥主ｿ・ｒ險倬鹸縺励・/p>
              <p>逅・Φ縺ｮ閾ｪ蛻・∈縺ｨ豁ｩ縺ｿ蜃ｺ縺昴≧縲・/p>
            </motion.div>
          </div>
        </section>
            ...
            <motion.div style={{ x: isMobile ? 0 : x2, scale: scale2 }} className="relative z-20 max-w-xl px-6">
              <MagneticButton className="w-full">
                <div className="group bg-white/5 backdrop-blur-md border border-white/10 p-8 md:p-12 rounded-3xl hover:border-violet-500/50 transition-colors cursor-none text-left">
                  ...
                  <p className="text-base md:text-lg text-white/60">AI縺後≠縺ｪ縺溘・諢滓ュ繝代ち繝ｼ繝ｳ繧貞・譫舌＠縲・國繧後◆蛯ｾ蜷代ｒ譏弱ｉ縺九↓縺励∪縺吶・/p>
                </div>
              </MagneticButton>
            </motion.div>
          </div>
            ...
            <motion.div style={{ x: isMobile ? 0 : x4, scale: scale4 }} className="relative z-20 max-w-xl px-6">
              <MagneticButton className="w-full">
                <div className="group bg-white/5 backdrop-blur-md border border-white/10 p-8 md:p-12 rounded-3xl hover:border-violet-500/50 transition-colors cursor-none text-left">
                  ...
                  <p className="text-base md:text-lg text-white/60">螟ｧ縺阪↑螟｢繧偵∵律縲・・螳溯｡悟庄閭ｽ縺ｪ繧ｹ繝・ャ繝励↓蛻・ｧ｣縺励∪縺吶・/p>
                </div>
              </MagneticButton>
            </motion.div>
          </div>
            ...
            <motion.div style={{ x: isMobile ? 0 : x6, scale: scale6 }} className="relative z-20 max-w-xl px-6">
              <MagneticButton className="w-full">
                <div className="group bg-white/5 backdrop-blur-md border border-white/10 p-8 md:p-12 rounded-3xl hover:border-violet-500/50 transition-colors cursor-none text-left">
                  ...
                  <p className="text-base md:text-lg text-white/60">Google縲＾utlook縲、pple繧ｫ繝ｬ繝ｳ繝繝ｼ縺ｨ繧ｷ繝ｼ繝繝ｬ繧ｹ縺ｫ騾｣謳ｺ縺励∪縺吶・/p>
                </div>
              </MagneticButton>
            </motion.div>
          </div>
        ...
        <section className="relative py-32 md:py-48 px-6 text-center">
          ...
          >
            <h2 className="text-4xl md:text-6xl font-bold mb-8 text-white md:whitespace-nowrap">
              縺ゅ↑縺溘・迚ｩ隱槭・縲・br className="md:hidden" />莉頑律縺九ｉ蟋九∪繧・
            </h2>
            <p className="text-lg md:text-2xl text-white/70 mb-12 leading-relaxed">
              荳豁ｩ縺壹▽縲∫｢ｺ螳溘↓縲・br />
              縺ゅ↑縺溘・螟｢繧堤樟螳溘↓螟峨∴繧区羅繧偵・br className="md:hidden" />
              莉翫％縺薙°繧牙ｧ九ａ縺ｾ縺励ｇ縺・・
            </p>
            <MagneticButton>
              <Link
