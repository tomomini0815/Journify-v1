...
export function LifeBalanceChart({ data: initialData }: { data?: { category: string, value: number }[] }) {
    ...
    return (
        ...
        >
            ...
            <div className="h-[300px] sm:h-[400px] min-h-[300px] min-w-0 relative outline-none focus:outline-none [&_.recharts-surface]:outline-none [&_.recharts-wrapper]:outline-none *:focus:outline-none" style={{ width: '100%', minWidth: 0 }}>
                {/* 背景のグロー効果 */}
